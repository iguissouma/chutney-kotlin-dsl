...
class GradleWrappingTest : ParametrizedMethods() {
    ...
    fun `is able to run a scenario on different environments by names`(environmentName: String) {
        launcher.run(call_a_website, environmentName)
    }
