...
enum class ChutneyConfigurationParameters(val parameter: String, private val default: Any? = null) {
    ...
    CONFIG_ENVIRONMENT_ROOT_PATH("junit.chutney.environment.rootPath", CHUTNEY_ENV_ROOT_PATH_DEFAULT),
    CONFIG_ENGINE_STEP_AS_TEST("junit.chutney.engine.stepAsTest", true),
    CONFIG_REPORT_ROOT_PATH("junit.chutney.report.rootPath", CHUTNEY_REPORT_ROOT_PATH_DEFAULT),
